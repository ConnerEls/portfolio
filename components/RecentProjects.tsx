  ...
  return (
    <div className='py-20 mt-10' id='projects'>
      <h1 className='heading'>
        ...
        <span className='text-pink-500'>recent projects</span> to be done
      </h1>
                    ...
                    <div className='flex items-center justify-between mt-7 mb-3'>
                        <div className='flex items-center'>
                            {iconLists.map((icon, index) => (
                                <div key={icon} className='border border-white/[0.2] rounded-full bg-black lg:w-10 lg:h-10 sm:w-10 h-10 flex justify-center items-center'
